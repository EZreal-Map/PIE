                ...
                try
                {
                    if (this.UsersList.Length > 0)
                    {
                        ...
                        if (tmpJArray != null && tmpJArray.Count > 0)
                        {
                            ...
                            foreach (JObject tmpObj in tmpJArray)
                            {
                                if (tmpObj["parentid"].ToString() == "-")
                                {
                                    ...
                                    string tmpusername = tmpObj["username"].ToString();
                                    if (!tmpArray.Contains(tmpusername))
                                        tmpArray.Add(tmpusername);
                                    break;
                                }
                            }
                            if (tmpMainID != "")
                        ...
                        if (tmpArray.Count > 0)
                        {
                            ...
                            {
                                if (this.AllUsersListStr.Length > 0)
                                    this.AllUsersListStr += ",";
                                this.AllUsersListStr += "'" + tmpStr + "'";
                            }
                        }
                    }
                }
