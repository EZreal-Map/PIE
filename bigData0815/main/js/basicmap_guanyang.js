...
var m_DefaultMapCenterOfWGS84 = [114.175097031, 22.598981100];
...
function initialMap() {
	...
	mapselect = new ol.interaction.Select({
		layers: [riverSectionLayer, StationLayer, GYEventLayer, UserGPSLayer, TyphoonLayer,CameraLayer]
	});
...
//	//水库
//	$.ajax({
//		url: mapServerURL + "ServiceHandler/StationHandler.ashx?method=getallrtuinfo&type=2",
//		type: "GET",
//		dataType: "json",
//		success: function(joResult) {
//			if(joResult.success == true) {
...
//	//排洪口
//	$.ajax({
//		url: mapServerURL + "ServiceHandler/StationHandler.ashx?method=getallrtuinfo&type=1",
//		type: "GET",
//		dataType: "json",
//		success: function(joResult) {
//			if(joResult.success == true) {
...
//	//桥
//	$.ajax({
//		url: mapServerURL + "ServiceHandler/StationHandler.ashx?method=getallrtuinfo&type=4",
//		type: "GET",
//		dataType: "json",
//		success: function(joResult) {
//			if(joResult.success == true) {
